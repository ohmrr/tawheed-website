  ...
  <div
    ...
    <div class="flex flex-col items-center justify-center space-y-4 text-center">
      ...
      <a
        ...
        class="rounded-lg border-2 border-jade bg-jade p-2 text-center text-base font-bold text-white shadow-md transition duration-150 ease-in-out hover:-translate-y-1 hover:bg-jade-dark">
        Donate Now
      </a>
    </div>
  </div>
